...
const WorkOrder = () => (
    <div className='workorder-page'>
        ...
        <Box width={[0.8, 0.5]} ml='auto' mr='auto'>
            ...
            For complaints/work orders related to McMurtry public spaces, please use 
            <a href="https://docs.google.com/forms/d/e/1FAIpQLScCPOKCzAF0CCLFZg7hfNpfiVOVDt6dZjh-iomdNsljjmLykQ/viewform"> this link</a>.</p>
        </Box>     
    </div>
)
