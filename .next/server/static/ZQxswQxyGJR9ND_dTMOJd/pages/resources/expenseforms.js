...
module.exports = __webpack_require__("bVHW");
...
// EXTERNAL MODULE: ./components/resources/expenseforms/expenseforms.css
var expenseforms = __webpack_require__("oaGt");

// CONCATENATED MODULE: ./components/resources/expenseforms/expenseforms.js
...
var expenseforms_ExpenseForms =
/*#__PURE__*/
function (_React$Component) {
  Object(inherits["a" /* default */])(ExpenseForms, _React$Component);

  function ExpenseForms(props) {
    var _this;

    Object(classCallCheck["a" /* default */])(this, ExpenseForms);

    _this = Object(possibleConstructorReturn["a" /* default */])(this, Object(getPrototypeOf["a" /* default */])(ExpenseForms).call(this, props));
    _this.state = {
      slide: 0
    };
  ...
  Object(createClass["a" /* default */])(ExpenseForms, [{
    key: "handleClick",
    ...
    value: function render() {
      ...
      return external_react_default.a.createElement("div", {
        className: "reimbursements-page"
      }, external_react_default.a.createElement(title["a" /* default */], {
        title: "Expense Forms",
        width: 320,
        smallText: true
      }), external_react_default.a.createElement(external_rebass_["Box"], {
        className: "expense-instructions",
        ml: "auto",
        mr: "auto",
        width: [0.9, 0.7, 0.6, 0.55]
      }, external_react_default.a.createElement("h2", {
        className: "instructions-title"
      }, "Instructions"), external_react_default.a.createElement("ol", null, external_react_default.a.createElement("li", {
        className: "instructions-list-item"
      }, "Take a picture of the receipts and send it to the treasurers. Be sure to include what it was for."), external_react_default.a.createElement("li", {
        className: "instructions-list-item"
      }, "Fill out the ", external_react_default.a.createElement("strong", null, "Petty Cash Voucher Form"), ", following the template provided."), external_react_default.a.createElement("li", {
        className: "instructions-list-item"
      }, "Fill out the ", external_react_default.a.createElement("strong", null, "Business Meeting/Entertainment Expenses Form"), ", following the template provided."), external_react_default.a.createElement("li", {
        className: "instructions-list-item"
      }, "Get Jackie or one of the treasurers to sign the forms."), external_react_default.a.createElement("li", {
        className: "instructions-list-item"
      }, "Submit the receipts and forms to the registrar.")), external_react_default.a.createElement("h2", {
        className: "instructions-title"
      }, "Account Codes"), external_react_default.a.createElement("ul", null, external_react_default.a.createElement("li", {
        className: "instructions-list-item"
      }, "If you bought ANY alcohol, you must use code: 70880"), external_react_default.a.createElement("li", {
        className: "instructions-list-item"
      }, "Otherwise, any other purchases are under: 70877"))), external_react_default.a.createElement("h1", {
        className: "instructions-title"
      }, "Forms"), external_react_default.a.createElement(external_rebass_["Flex"], {
        flexDirection: "row",
        justifyContent: "center"
      }, expenseforms_forms.map(function (form) {
        return external_react_default.a.createElement("div", {
          onClick: function onClick() {
            return _this2.handleClick(expenseforms_forms.indexOf(form));
          },
          className: expenseforms_forms.indexOf(form) === _this2.state.slide ? 'active-form' : 'inactive-form',
          key: form.name
      ...
      }, external_react_default.a.createElement("embed", {
        src: expenseforms_forms[this.state.slide].document,
        ...
        href: expenseforms_forms[this.state.slide].document,
        target: "_blank",
        ...
        src: "".concat(expenseforms_forms[this.state.slide].icon, "/2B2F3A/90"),
        alt: ""
      }), external_react_default.a.createElement("p", null, expenseforms_forms[this.state.slide].name, " ", external_react_default.a.createElement("img", {
...
/* harmony default export */ var expenseforms_expenseforms = (expenseforms_ExpenseForms);
// EXTERNAL MODULE: ./components/general/page.css
var page = __webpack_require__("NHen");

// CONCATENATED MODULE: ./pages/resources/expenseforms.js
...
var expenseforms_ExpenseFormsPage = function ExpenseFormsPage() {
  return external_react_default.a.createElement("div", {
    className: "page"
  }, external_react_default.a.createElement(header["a" /* default */], null), external_react_default.a.createElement(navbarDesktop["a" /* default */], null), external_react_default.a.createElement(navbarMobile["a" /* default */], null), external_react_default.a.createElement(expenseforms_expenseforms, null), external_react_default.a.createElement(footer["a" /* default */], null));
};

/* harmony default export */ var resources_expenseforms = __webpack_exports__["default"] = (expenseforms_ExpenseFormsPage);
